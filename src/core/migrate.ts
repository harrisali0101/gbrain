...
export const MIGRATIONS: Migration[] = [
  ...
  },
  {
    ...
    //                      WhatsApp lid, Slack user id, email)
    ...
    // migration v118 below so it can run with CREATE INDEX CONCURRENTLY
  ...
  },
  {
    ...
    // is split out from v117 so Postgres can build it CONCURRENTLY
